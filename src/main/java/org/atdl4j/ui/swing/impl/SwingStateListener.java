...
public class SwingStateListener implements SwingListener {
    ...
    public SwingStateListener(SwingWidget<?> affectedWidget,
                              StateRuleT stateRule, Map<String, SwingWidget<?>> controls, Map<String,
            ValidationRule> refRules) throws FIXatdlFormatException {
